// 1. UI Elements
    ...
    async function startContinuousAudioSession() {
        ...
        try {
            ...
            for (let i = 0; i < NUMBER_OF_SEGMENTS; i++) {
                // CRITICAL CHECK: Exit the loop if the stop button was pressed or time exceeded
    ...
    async function transcribe(blob, segmentNumber, parentElement) {
        ...
        // Note: I'm keeping the original code's assumption that LanguageModel is globally available
